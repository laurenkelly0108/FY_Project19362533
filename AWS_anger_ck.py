...
folder_path = 'C:\\Users\\Lauren\\Downloads\\FY Project Datasets\\CK+48\\contempt'

# Specify the output folder paths for the CSV and JSON files
csv_output_folder = 'C:\\Users\\Lauren\\Downloads\\RESULTS\\CK\\AWS\\CSV'
json_output_folder = 'C:\\Users\\Lauren\\Downloads\\RESULTS\\CK\\AWS\\JSON'
...
for filename in os.listdir(folder_path):
    ...
    s3.Bucket(bucket_name).upload_file(image_file, image_name)
    ...
    with open(os.path.join(json_output_folder, f'{image_name}.json'), 'w') as json_file:
        json.dump(response, json_file)

# Write the emotions and confidence levels to a CSV file
with open(os.path.join(csv_output_folder, 'CONTEMPT_LUXresults.csv'), mode='w', newline='') as csv_file:

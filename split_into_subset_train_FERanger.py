...
folder_path = "C://Users/Lauren/Downloads/FY Project Datasets/FERTrain/fear"
...
# Select a random sample of 2800 image filenames
sample_filenames = random.sample(image_filenames, 2800)

# Create a new folder to store the sample images
sample_folder_path = "C://Users/Lauren/Downloads/FY Project Datasets/FERsubsets/train/fear"

...
image_directory = "C://Users/Lauren/Downloads/FY Project Datasets/FERsubsets/test/angry"

# Set output directory paths
csv_directory = "C://Users/Lauren/Downloads/RESULTS/FER/test/LUXAND/CSV"
json_directory = "C://Users/Lauren/Downloads/RESULTS/FER/test/LUXAND/JSON"
...
with open(os.path.join(csv_directory, 'ANGRY_LUX_FERresults.csv'), mode='w', newline='') as csv_file:
...
for filename in image_files:
    ...
    if result is not None:
        ...
        if result["status"] == "failure":
            ...
            with open(os.path.join(csv_directory, 'ANGRY_LUX_FERresults.csv'), mode='a', newline='') as csv_file:
                writer = csv.writer(csv_file)
                writer.writerow([image_name, result["status"], 0, 0, 0, 0, 0, 0, 0, 0])
            
            print("No faces in {}.".format(image_name))
        else:
